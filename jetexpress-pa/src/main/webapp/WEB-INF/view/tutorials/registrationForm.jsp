...
<form action="<c:out value='${requestScope.registerUserActionUrl}'/>" method="POST">
    <table width="200px">
        <tr>
            <td colspan="2">
                <font color="#FF0000"><c:out
                        value="${sessionScope.errorMsg}"/></font>
            </td>
        </tr>
        <tr>
            <td><fmt:message key="label.firstName"/></td>
            <td><input type="text" name="firstName" value="${sessionScope.user.firstName}"></input></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
        <tr>
            ...
            <td><input type="text" name="lastName" value="${sessionScope.user.lastName}"></input></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
